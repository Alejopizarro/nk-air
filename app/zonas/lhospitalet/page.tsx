      ...
      >
        ...
        >
          ...
          <h1 style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: "clamp(36px, 4.5vw, 62px)", letterSpacing: "-0.04em", lineHeight: 0.98, color: "var(--text)", marginBottom: 24, animation: "fadeSlideUp 0.6s 0.1s ease both" }}>
            Climatización en<br />
            <span style={{ color: "var(--accent)" }}>L&apos;Hospitalet</span><br />
            de Llobregat
          </h1>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 300, fontSize: 16, color: "var(--muted2)", lineHeight: 1.75, maxWidth: 460, marginBottom: 36, animation: "fadeSlideUp 0.6s 0.2s ease both" }}>
            Servicio profesional de instalación y reparación de aire acondicionado en L&apos;Hospitalet. Técnicos con experiencia en pisos y locales de todos los barrios de la ciudad.
          </p>

          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 48, animation: "fadeSlideUp 0.6s 0.3s ease both" }}>
            <a href={getWhatsAppUrl("Hola, necesito un presupuesto en L'Hospitalet de Llobregat.")} target="_blank" rel="noopener noreferrer" className="btn-primary">
              Pedir presupuesto
        ...
        <div className="zone-hero-right" style={{ position: "relative", overflow: "hidden" }}>
          <Image src="/hero-nk.jpg" alt="Técnico NK Air en L'Hospitalet de Llobregat" fill className="object-cover" priority style={{ filter: "grayscale(20%)", animation: "heroImgIn 1.2s 0s cubic-bezier(0.16,1,0.3,1) both" }} />
        ...
        <div className="container-main">
          <div style={{ marginBottom: 48 }}>
            ...
            <h2 className="reveal reveal-delay-1" style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: "clamp(28px, 3vw, 44px)", letterSpacing: "-0.04em", lineHeight: 1.02, color: "var(--text)" }}>
              Lo que ofrecemos<br />en L&apos;Hospitalet.
            </h2>
          </div>
          <div className="zone-svc-cards">
            {[
              { icon: svgAC, title: "Aire Acondicionado", href: "/servicios/climatizacion", desc: "Instalación y reparación de splits en pisos y locales de L'Hospitalet. Técnicos con experiencia en edificios de la ciudad." },
              { icon: svgAero, title: "Aerotermia", href: "/servicios/aerotermia", desc: "Soluciones aerotérmicas para comunidades y viviendas en L'Hospitalet con gestión de subvenciones incluida." },
              { icon: svgPlumb, title: "Fontanería", href: "/servicios/fontaneria", desc: "Fontaneros en L'Hospitalet para reparaciones urgentes, reformas de baños e instalaciones nuevas." },
              { icon: svgCold, title: "Cámaras Frigoríficas", href: "/servicios/camaras-frigorificas", desc: "Frío comercial para negocios del sector alimentario en L'Hospitalet y zona metropolitana." },
            ].map((s, i) => (
        ...
        <div className="container-main">
          <div className="detail-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            <div className="reveal">
              <p style={{ fontFamily: "var(--font-dm-mono)", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--accent)", marginBottom: 16 }}>Cobertura L&apos;Hospitalet</p>
              <h2 style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: "clamp(28px, 3vw, 44px)", letterSpacing: "-0.04em", lineHeight: 1.05, color: "var(--text)", marginBottom: 20 }}>
                Especialistas en pisos y edificios de L&apos;Hospitalet.
              </h2>
              <p style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 300, fontSize: 15, color: "var(--muted2)", lineHeight: 1.75, marginBottom: 28 }}>
                L&apos;Hospitalet es una ciudad densa donde la instalación de climatización en pisos requiere técnicos experimentados. Nuestro equipo conoce bien los edificios de la ciudad y sabe cómo instalar sistemas eficientes minimizando el impacto estético y estructural.
              </p>
              <ul style={{ listStyle: "none", padding: 0, marginBottom: 32 }}>
                {[
                  "Cobertura en todos los barrios de L'Hospitalet",
                  "Experiencia en instalaciones en pisos y áticos",
                  "Técnicos disponibles en 24-48h",
              ...
              <a href={getWhatsAppUrl("Hola, necesito presupuesto para un servicio en L'Hospitalet de Llobregat.")} target="_blank" rel="noopener noreferrer" className="btn-primary">
                Solicitar presupuesto
              </a>
            </div>
            <div className="reveal reveal-delay-2" style={{ position: "relative" }}>
              <div style={{ aspectRatio: "4/3", borderRadius: 12, overflow: "hidden", position: "relative" }}>
                <Image src="/nkair-working.jpg" alt="Técnico NK Air en L'Hospitalet" fill className="object-cover detail-img" style={{ transition: "transform 0.4s ease" }} />
              </div>
