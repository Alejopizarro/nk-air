...
const svgInstall = "M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437l1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008z";
const svgRepair = "M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z";
const svgClean = "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z";
const svgReplace = "M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99";
const svgContract = "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4";
const svgGas = "M12 3c0 0-5.5 6-5.5 10a5.5 5.5 0 0011 0C17.5 9 12 3 12 3z M9.5 13a2.5 2.5 0 005 0";
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Instalación de<br />
            <span style={{ color: "var(--accent)" }}>aire acondicionado</span><br />
            profesional
          </h1>
          ...
          >
            Instalamos, reparamos y mantenemos todo tipo de equipos de climatización en Viladecans y el Baix Llobregat. Más de 25 años de experiencia con Daikin, Mitsubishi, Fujitsu, LG y Samsung.
          </p>
          ...
          >
            {[
              ...
              >
                <p style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: 28, letterSpacing: "-0.05em", color: "var(--text)", lineHeight: 1 }}>
                  {stat.value}
                </p>
                <p style={{ fontFamily: "var(--font-dm-mono)", fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--muted)", marginTop: 6 }}>
                  {stat.label}
                </p>
              </div>
            ))}
        ...
        <div className="svc-hero-right" style={{ position: "relative", overflow: "hidden" }}>
          <Image
            ...
            priority
            style={{ filter: "grayscale(20%)", animation: "heroImgIn 1.2s 0s cubic-bezier(0.16,1,0.3,1) both" }}
          />
          <div style={{
            position: "absolute", inset: 0,
            background: "linear-gradient(to right, var(--bg) 0%, transparent 40%), linear-gradient(to bottom, var(--bg) 0%, transparent 30%), linear-gradient(to top, var(--bg) 0%, transparent 35%)",
            pointerEvents: "none",
          }} />
          <div style={{ position: "absolute", right: 32, top: "50%", transform: "translateY(-50%)", display: "flex", flexDirection: "column", gap: 10 }}>
            {["Daikin", "Mitsubishi", "Fujitsu", "LG", "Samsung"].map((brand, i) => (
              <span key={brand} style={{ fontFamily: "var(--font-dm-mono)", fontSize: 11, letterSpacing: "0.14em", color: "var(--muted)", textTransform: "uppercase", animation: `fadeSlideLeft 0.6s ${0.5 + i * 0.1}s ease both` }}>
                {brand}
              </span>
            ))}
          </div>
      ...
      <section id="servicios" style={{ padding: "100px 0", background: "var(--bg)" }}>
        <div className="container-main">
          <div style={{ marginBottom: 48 }}>
            <p className="reveal" style={{ fontFamily: "var(--font-dm-mono)", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--muted)", marginBottom: 12 }}>
              Servicios incluidos
            </p>
            <h2 className="reveal reveal-delay-1" style={{ fontFamily: "var(--font-syne)", fontWeight: 800, fontSize: "clamp(28px, 3vw, 44px)", letterSpacing: "-0.04em", lineHeight: 1.02, color: "var(--text)" }}>
              Todo lo que necesitas<br />para tu climatización.
            </h2>
          </div>

          <div className="svc-cards reveal reveal-delay-2">
            {[
              { icon: svgInstall, title: "Instalación nueva", desc: "Splits, multisplits, conductos y VRV/VRF para hogares y negocios de cualquier tamaño." },
              { icon: svgRepair, title: "Reparación de averías", desc: "Diagnóstico rápido y reparación de cualquier avería en 24-48h con garantía de trabajo." },
              { icon: svgClean, title: "Limpieza y mantenimiento", desc: "Revisión y limpieza de filtros y componentes para mantener el equipo en óptimas condiciones." },
              { icon: svgReplace, title: "Sustitución de equipos", desc: "Cambio de equipos obsoletos por nuevos modelos de mayor eficiencia energética A+++." },
              { icon: svgContract, title: "Contratos de mantenimiento", desc: "Revisiones periódicas programadas para empresas y comunidades de vecinos." },
              { icon: svgGas, title: "Recarga de gas", desc: "Recarga y verificación del gas refrigerante con cumplimiento de la normativa F-Gas vigente." },
            ].map((s) => (
              <div
                key={s.title}
              ...
              >
                ...
                <p style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 300, fontSize: 14, color: "var(--muted2)", lineHeight: 1.7 }}>
                  {s.desc}
                </p>
              </div>
            ))}
        ...
        <div className="container-main">
          <div className="detail-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            <div className="reveal">
              <p style={{ fontFamily: "var(--font-dm-mono)", fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--accent)", marginBottom: 16 }}>
              ...
              <p style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 300, fontSize: 15, color: "var(--muted2)", lineHeight: 1.75, marginBottom: 28 }}>
                Instalamos todo tipo de sistemas de climatización para viviendas, oficinas y locales comerciales. Realizamos el dimensionado correcto del equipo según la superficie y orientación para garantizar la máxima eficiencia.
              </p>
              ...
              <a href={getWhatsAppUrl("Hola, me gustaría pedir presupuesto para instalación de aire acondicionado.")} target="_blank" rel="noopener noreferrer" className="btn-primary">
                Solicitar presupuesto
              </a>
            </div>
            <div className="reveal reveal-delay-2" style={{ position: "relative" }}>
              <div style={{ aspectRatio: "4/3", borderRadius: 12, overflow: "hidden", position: "relative" }}>
                <Image src="/nkair-working.jpg" alt="Instalación profesional de aire acondicionado" fill className="object-cover detail-img" style={{ transition: "transform 0.4s ease" }} />
              </div>
        ...
        <div className="container-main">
          <div className="detail-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center", direction: "rtl" }}>
            <div className="reveal" style={{ direction: "ltr", position: "relative" }}>
              <div style={{ aspectRatio: "4/3", borderRadius: 12, overflow: "hidden", position: "relative" }}>
                <Image src="/nkair-barometro.jpg" alt="Reparación y mantenimiento de equipos de climatización" fill className="object-cover detail-img" style={{ transition: "transform 0.4s ease" }} />
              </div>
            ...
            <div className="reveal reveal-delay-2" style={{ direction: "ltr" }}>
              ...
              <p style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 300, fontSize: 15, color: "var(--muted2)", lineHeight: 1.75, marginBottom: 28 }}>
                Si tu equipo tiene una avería o rinde por debajo de lo esperado, nuestro equipo técnico lo diagnostica y repara en 24-48h. También ofrecemos contratos de mantenimiento preventivo para alargar la vida útil de tu instalación.
              </p>
              <ul style={{ listStyle: "none", padding: 0, marginBottom: 32 }}>
                {[
              ...
              <a href={getWhatsAppUrl("Hola, tengo una avería en mi equipo de aire acondicionado.")} target="_blank" rel="noopener noreferrer" className="btn-primary">
                Reportar avería
              </a>
            </div>
          </div>
        ...
        <div className="container-main">
          ...
          <div className="reveal reveal-delay-1" style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 60, flexWrap: "wrap" }}>
            {["Daikin", "Mitsubishi", "Fujitsu", "LG", "Samsung"].map((brand) => (
              <span key={brand} className="brand-name" style={{ fontFamily: "var(--font-syne)", fontWeight: 700, fontSize: 20 }}>
                {brand}
              </span>
            ))}
          </div>
